...
var update = __webpack_require__(6)("18a4f44c", content, false, {});
...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n/* Scoped Styles */\n.grid[data-v-68ff5483] {\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr 1fr;\n    grid-auto-rows: 150px;\n    grid-gap: 1rem;\n    position: relative;\n    border-radius: 8px;\n    min-height: 150px;\n}\nimg[data-v-68ff5483] {\n    width: 100%;\n    height: 100%;\n    -o-object-fit: cover;\n       object-fit: cover;\n}\n.drag-area[data-v-68ff5483] {\n    width: 100%;\n    height: 150px;\n    border-radius: 8px;\n    background-color: white;\n    position: relative;\n    font-weight: 600;\n    color: black;\n}\n.is-dropping[data-v-68ff5483] {\n    border: 2px dashed orange;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getAlbumImages: function getAlbumImages() {
            var _this = this;

            this.request('GET', this.apiUrl + 'album/' + this.albumId + '/images').then(function (res) {
        ...
        sendFileToApi: function sendFileToApi(file) {
            var _this3 = this;
            ...
            reader.onload = function (e) {
                ...
                var imgData = {
                    ...
                    title: file.name,
                    type: 'base64',
                    album: _this3.deleteHash
                };

                _this3.request('POST', _this3.apiUrl + 'image', imgData).then(function (res) {
                    _this3.images.push(res.data.data);
                });
            };
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        staticClass:
          "drag-area mb-4 flex justify-center items-center select-none",
        class: { "is-dropping": _vm.isDropping },
        on: {
    ...
    _c(
      "div",
      {
        ...
        staticClass: "bg-90 grid p-4"
      },
      _vm._l(_vm.images, function(image) {
        return _c("div", { key: image.link }, [
          _c("img", { attrs: { src: image.link, alt: image.title } })
        ])
      }),
      0
    )
